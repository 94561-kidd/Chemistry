...
- 存在
  ...
  2. 外層電子組態為 3s^2^3p^1^，有 3 個價電子，化性活潑，自然界無元素態存在
...
- 性質、用途
  ...
  3. 是兩性金屬，可溶於強酸、強鹼，釋出 $\ce{H2}$

     > $\ce{2Al + 6H+ -> 2Al^3+ +3H2}$
     >
     > $\ce{2Al + 2OH- + 6H2O -> 2Al(OH)4- + 3H2}$

  4. 化合物中以 +3 價存在，具有部分共價性

  5. $\ce{Al^3+}$ 電荷密度高、水合能大，因此 $\ce{Al}$ 在水溶液中為強還原劑，可還原其他金屬

     > $\ce{Al(s) -> Al^3+(aq) + 3e-}$          $\ce{E°= 1.66 V}$

  6. 在空氣中，表面易生成 $\ce{Al2O3}$，由於 $\ce{Al2O3}$ 薄膜十分緻密，可保護內部不再氧化，有防蝕功能

  7. 鋁熔劑：$\ce{Al}$ 和金屬氧化物混合，使其燃燒，還原氧化物、釋出大量熱能
